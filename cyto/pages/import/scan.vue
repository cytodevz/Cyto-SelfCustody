                            ...
                            <form action="#" id="PassKeyFormId">
                                ...
                                <div class="p-2">
                                    <button class="btn btn-wide btn-primary" :class="loading"
                                        @click.prevent="activateScanner()">Scan
                                    </button>
                                </div>

                                <div class="p-2">
                                    <NuxtLink class="btn btn-wide  btn-secondary" to="/import">Upload </NuxtLink>

                                </div>
                                <div class="p-2">
                                    <button id="stop-button" class="btn btn-wide btn-ghost"
                                        >Cancel
                                    </button>
                                </div>
    ...
    methods: {
        ...
        activateScanner2() {
            ...
            const setResult = (label, result) => {
                ...
                this.pICresult = result.data;
                this.store.$state.address = result.data;
                if (this.store.$state.address) {
                    Swal.fire('Successful', this.store.$state.address, 'success');
                    scanner.stop();
